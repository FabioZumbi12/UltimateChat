package br.net.fabiozumbi12.UltimateChat.Fanciful;

import static br.net.fabiozumbi12.UltimateChat.Fanciful.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	public FancyMessage tooltip(final String text) {
		String text1 = ChatColor.translateAlternateColorCodes('&', text);
		onHover("show_text", new JsonString(text1));
		return this;
	}
	...
	public FancyMessage tooltip(final String... lines) {
		...
		for(int i = 0; i < lines.length; i++){
			String text1 = ChatColor.translateAlternateColorCodes('&', lines[i]);
