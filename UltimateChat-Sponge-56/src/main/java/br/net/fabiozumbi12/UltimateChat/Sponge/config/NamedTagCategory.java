...
@ConfigSerializable
public class NamedTagCategory {
	
	public NamedTagCategory(){}
	 ...
	 */
	public NamedTagCategory(String format, String click_cmd, List<String> hover_messages, String permission, List<String> show_in_worlds, List<String> hide_in_worlds){
		this.format = format;
