...
## Dev Builds:
Dev builds on Jenkins: [![Build Status](http://host.areaz12server.net.br:8080/buildStatus/icon?job=UltimateChat)](http://host.areaz12server.net.br:8080/job/UltimateChat/)
